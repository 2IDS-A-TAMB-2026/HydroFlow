...
CREATE TABLE HISTORICO_IRRIGACAO (
    ...
    FOREIGN KEY (FK_USU_ID) REFERENCES USUARIO(USU_ID),
    FOREIGN KEY (FK_PLANTA_ID) REFERENCES PLANTA(PLANTA_ID),
    FOREIGN KEY (FK_DIS_ID) REFERENCES DISPOSITIVO(DIS_ID)
);
...
('08:15:00', '2021-11-11', 42.30, 21.2, 1),
('08:30:00', '2020-10-10', 88.00, 21.2, 1),
('08:45:00', '2023-10-01', 60.15, 23.2, 1),
('09:00:00', '2023-10-02', 35.40, 25.2, 1),
('09:15:00', '2023-10-03', 22.10, 23.2, 1),
('09:30:00', '2023-10-04', 75.00, 25.2, 1),
('09:45:00', '2023-10-05', 10.50, 27.2, 1),
('10:00:00', '2023-10-06', 55.80, 26.2, 1),
('10:15:00', '2023-10-07', 92.33, 26.2, 1),
('10:30:00', '2023-10-08', 40.00, 26.2, 1),
('10:45:00', '2023-10-09', 66.75, 28.2, 1),
('11:00:00', '2023-10-09', 30.20, 28.2, 1),
('11:15:00', '2023-10-10', 15.00, 30.2, 1),
('11:30:00', '2023-10-11', 82.40, 30.2, 1),
('11:45:00', '2023-10-12', 48.90, 30.2, 1),
('12:00:00', '2023-10-13', 50.00, 31.2, 1),
('12:15:00', '2023-10-14', 12.00, 31.2, 1),
('12:30:00', '2023-10-15', 25.60, 31.2, 1),
('12:45:00', '2023-10-16', 05.50, 31.2, 1),
('13:00:00', '2023-10-17', 99.10, 31.2, 1),
('13:15:00', '2023-10-18', 33.33, 31.2, 1),
('13:30:00', '2023-10-19', 44.50, 30.2, 1),
('13:45:00', '2023-10-20', 61.20, 30.2, 1),
('14:00:00', '2023-10-21', 77.80, 30.2, 1),
('14:15:00', '2023-10-22', 19.90, 30.2, 1),
('14:30:00', '2023-10-23', 85.00, 30.2, 1),
('14:45:00', '2023-10-24', 30.00, 29.2, 1),
('15:00:00', '2023-10-25', 41.25, 29.2, 1),
('15:15:00', '2023-10-26', 95.00, 29.2, 1);
...
SELECT * FROM PLANTA 
 ...
 ALTER TABLE DADOS_SENSORES ADD DDS_UMIDADE_SOLO  DECIMAL(4 , 2) NOT NULL;
 ALTER TABLE USUARIO ADD USU_RUA  VARCHAR(255) NOT NULL;
 SELECT *FROM DADOS_SENSORES;
...
INSERT INTO HISTORICO_IRRIGACAO (IRR_DATA, IRR_HORA, IRR_DURACAO, IRR_VOLUME, IRR_ACIONAMENTO, IRR_STATUS, FK_USU_ID, FK_PLANTA_ID, FK_DIS_ID) VALUES
    ...
    select * from HISTORICO_IRRIGACAO where FK_USU_ID = 1;
    
    SELECT s.SEN_ID, s.SEN_NOME, s.FK_DIS_ID, d.FK_USU_ID 
FROM SENSOR s
JOIN DISPOSITIVO d ON d.DIS_ID = s.FK_DIS_ID
WHERE d.FK_USU_ID = 1;

ALTER TABLE DADOS_SENSORES 
MODIFY DDS_UMIDADE_SOLO DECIMAL(4, 2) NOT NULL DEFAULT 0.00;
...
CREATE TRIGGER TRI_INSERIR_DATA_HORA
BEFORE INSERT ON DADOS_SENSORES
FOR EACH ROW
BEGIN
    SET NEW.DDS_DATA = CURDATE();
    SET NEW.DDS_HORA = CURTIME();
END$$
...
INSERT INTO DADOS_SENSORES 
    (DDS_UMIDADE, DDS_TEMP, FK_SEN_ID)
VALUES
    (75.5, 28.3, 1);
