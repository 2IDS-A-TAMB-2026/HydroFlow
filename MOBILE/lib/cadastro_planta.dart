...
class _CadastroPlantaPageState extends State<CadastroPlantaPage> {
  ...
  // Verifica se o usuário logado é admin para exibir opções extras no menu
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        const Row(
                          children: [
                            Icon(Icons.eco, color: Color(0xFF00a65a)),
                            SizedBox(width: 10),
                            Text("Nova Planta",
                        ...
                        OutlinedButton.icon(
                          ...
                          label: const Text("Ver Cadastradas"),
                          style: OutlinedButton.styleFrom(foregroundColor: const Color(0xFF002855)),
                        ),
                      ],
                    ),
                    const Divider(height: 30),

                    const Text("Informações da Espécie",
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(
                          labelText: "Nome da Planta", border: OutlineInputBorder(), hintText: "Ex: Tomate Carmem"),
                    ),
                    const SizedBox(height: 15),
                      ...
                      children: [
                        Expanded(
                          child: DropdownButtonFormField<String>(
                            ...
                            items: ["Hortaliça", "Frutífera", "Legume", "Grão", "Ornamental"]
                        ...
                        Expanded(
                          child: TextFormField(
                            ...
                            decoration: const InputDecoration(
                                labelText: "Cultura", border: OutlineInputBorder(), hintText: "Ex: Solanáceas"),
                          ),
                        ),
                      ],
                    ),
                    ...
                    const Text("Parâmetros de Irrigação",
                        style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.blueGrey)),
                    const SizedBox(height: 15),
                      ...
                      children: [
                        Expanded(
                          ...
                          child: TextFormField(
                            ...
                            decoration: const InputDecoration(
                                labelText: "Qtd. de Água", border: OutlineInputBorder()),
                          ),
                        ),
                        const SizedBox(width: 10),
                        Expanded(
                          flex: 1,
                          child: DropdownButtonFormField<String>(
                            initialValue: _unidadeAgua,
                            decoration: const InputDecoration(border: OutlineInputBorder()),
                            items: ["Litros/dia", "mm/dia", "mL/dia"]
                                .map((u) => DropdownMenuItem(value: u, child: Text(u))).toList(),
                            onChanged: (val) => setState(() => _unidadeAgua = val!),
                          ),
                        ),
                      ],
                    ),
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: ["Irriga 1000", "Hortas 03012", "Irrigation PRO"]
                      ...
                      children: [
                        Expanded(
                          ...
                          child: TextFormField(
                            ...
                            keyboardType: TextInputType.number,
                            decoration: const InputDecoration(
                                labelText: "Periodicidade", border: OutlineInputBorder(), hintText: "Ex: 12"),
                          ),
                        ),
                        const SizedBox(width: 10),
                        Expanded(
                          flex: 1,
                          child: DropdownButtonFormField<String>(
                            initialValue: _unidadeTempo,
                            decoration: const InputDecoration(border: OutlineInputBorder()),
                            items: ["Horas", "Dias", "Semanas"]
                                .map((u) => DropdownMenuItem(value: u, child: Text(u))).toList(),
                            onChanged: (val) => setState(() => _unidadeTempo = val!),
                          ),
                        ),
                      ],
                    ),
                          ...
                          onPressed: () {
                            if (_formKey.currentState!.validate()) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(content: Text("Planta Salva com Sucesso!")));
                            }
                          },
  ...
  // --- DRAWER ATUALIZADO (Mesmo padrão da imagem enviada) ---
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            _drawerItem(Icons.eco, "Cadastro de Plantas", () => Navigator.pop(context), active: true),
