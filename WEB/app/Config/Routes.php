...
$routes->group('api', ['filter' => 'cors'], function ($routes) {
    ...
    // DADOS DOS SENSORES
    $routes->get('dados_sensores', 'api\dadosSensoresController::index');
    $routes->get('dados_sensores/(:num)', 'api\dadosSensoresController::show/$1');

    $routes->post('dados_sensores', 'api\dadosSensoresController::create');

    $routes->put('dados_sensores/(:num)', 'api\dadosSensoresController::update/$1');

    $routes->patch('dados_sensores/(:num)', 'api\dadosSensoresController::update/$1');
...
$routes->group('admin', ['filter' => 'auth'], function($routes) {
    ...
    $routes->get('admin/usuarios/getJson/(:num)', 'AdmController::getJson/$1');
    // ============================================================
